...
const URL = "https://api.covid19api.com/summary";//working
const URL2 = "https://coronavirus-19-api.herokuapp.com/countries";//working
const url5="https://api.covid19india.org/v2/state_district_wise.json"//working
const url4="http://covid19-india-adhikansh.herokuapp.com/states"//not working
const url3="https://api.covid19india.org/data.json"//working
        ...
        //  console.log(perMillionCases); //do not delete this
          ...
          axios.get(URL)
            .then(function(response) {
              ...
              console.log(specific_india_top_card_data);
